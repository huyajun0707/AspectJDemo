...
public class TraceDatabaseHelper {
    ...
    public TraceDatabaseHelper(Context context, String packageName) {
        mContentResolver = context.getContentResolver();
        mAppStart = Uri.parse("content://" + packageName + TraceDataContentProvider + AopConstant.AppStartAndEndKey.APP_STARTED);
        mAppEndState = Uri.parse("content://" + packageName + TraceDataContentProvider + AopConstant.AppStartAndEndKey.APP_END_STATE);
        mAppPausedTime = Uri.parse("content://" + packageName + TraceDataContentProvider + AopConstant.AppStartAndEndKey.APP_PAUSED_TIME);
    }
